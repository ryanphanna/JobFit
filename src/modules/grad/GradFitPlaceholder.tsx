            ...
            <div className="flex flex-col items-center justify-start animate-in fade-in duration-700 relative min-h-[80vh] pt-16 pb-12">
                <div className="w-full max-w-6xl px-4 relative">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-2xl text-slate-500 dark:text-slate-400 leading-relaxed max-w-3xl mx-auto">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-2 mb-1">
                                                    <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Degree Progress</div>
                                                </div>
                                                <div className="flex items-baseline gap-1">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-12 bg-transparent text-sm text-slate-500 font-bold border-b border-slate-700 focus:border-indigo-500 focus:text-indigo-400 outline-none text-center transition-colors"
                                                    />
                                                    <span className="text-[10px] text-slate-600 font-black uppercase ml-1">Credits</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div key={i} className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl p-8 rounded-3xl border border-white/50 dark:border-slate-700/50 shadow-sm relative overflow-hidden group/sem">
                                            ...
                                            <div className="flex justify-between items-end mb-6 relative">
                                                <div>
                                                    ...
                                                    <p className="text-sm font-medium text-slate-500">{sem.year}</p>
                                                </div>
                                            ...
                                            <div className="space-y-3 relative">
                                                {sem.courses.map((c, j) => (
                                                    <div
                                                        ...
                                                        className="flex items-center justify-between p-4 bg-slate-50/50 dark:bg-slate-900/50 rounded-2xl group/course hover:bg-white dark:hover:bg-slate-800 transition-all border border-transparent hover:border-indigo-200 dark:hover:border-indigo-800 cursor-pointer active:scale-[0.99]"
                                                    >
